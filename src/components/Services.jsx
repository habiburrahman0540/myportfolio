  ...
  return (
        <div className="service" id="service">
            <div className="content-inner">
                ...
                <p style={{ color: "#333", fontSize: "20px", fontWeight: 500 }}>Transforming businesses with expert web solutions. From captivating landing pages to full website creation, seamless e-commerce setups, speed optimization, SEO, and bug fixing – I ensure your online presence thrives.</p>
